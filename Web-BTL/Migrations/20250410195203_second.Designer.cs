...
namespace Web_BTL.Migrations
{
    ...
    [Migration("20250410195203_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_BTL.Models.Actor_MediaModel", b =>
                {
                    b.Property<int>("MediaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_BTL.Models.ActorModel", b =>
                {
                    b.Property<int>("ActorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_BTL.Models.AdminModel", b =>
                {
            ...
            modelBuilder.Entity("Web_BTL.Models.CustomerModel", b =>
                {
            ...
            modelBuilder.Entity("Web_BTL.Models.GenreModel", b =>
                {
                    b.Property<int>("GenreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_BTL.Models.ListMediaModel", b =>
                {
                    b.Property<int?>("WatchListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_BTL.Models.MediaModel", b =>
                {
                    b.Property<int>("MediaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_BTL.Models.WatchListModel", b =>
                {
                    b.Property<int>("WatchListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Media_Genre", b =>
                {
                    b.HasOne("Web_BTL.Models.GenreModel", null)
                        .WithMany()
                        .HasForeignKey("GenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_BTL.Models.MediaModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Web_BTL.Models.Actor_MediaModel", b =>
                {
                    b.HasOne("Web_BTL.Models.ActorModel", "Actor")
                        .WithMany("Medias")
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_BTL.Models.MediaModel", "Media")
                        .WithMany("Actors")
                        .HasForeignKey("MediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web_BTL.Models.CustomerModel", b =>
                {
                    b.HasOne("Web_BTL.Models.WatchListModel", "WatchList")
                        .WithOne("User")
                        .HasForeignKey("Web_BTL.Models.CustomerModel", "WatchListId");
            ...
            modelBuilder.Entity("Web_BTL.Models.ReviewModel", b =>
                {
                    b.HasOne("Web_BTL.Models.CustomerModel", "UserModel")
                        .WithMany("Reviews")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_BTL.Models.MediaModel", "Medias")
                        .WithMany("Reviews")
                        .HasForeignKey("MediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
